...
const VoronoiDiagram = ({ 
  ...
  }, [domains, semanticDistances, width, height, selectedDomain, onDomainClick, onDocumentClick, onDeleteDomain, onViewDomain]);
      ...
      {selectedDomain && (
        <div className="domain-details">
          ...
          {selectedDomain.children && selectedDomain.children.length > 0 && (
            <p>
              <span className="domain-action">
                Double-click to navigate to subdomains ({selectedDomain.children.length})
              </span>
            </p>
          )}
